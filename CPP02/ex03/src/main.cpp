...
/*   Updated: 2025/09/09 17:24:41 by akdovlet         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int main() {
	...
	std::cout << "\n=== Testing Exercise 01: Constructors, Conversions, and << ===" << std::endl;
	{
		...
		std::cout << "Raw value: " << negFloat.getRawBits() << std::endl;
		std::cout << "toInt: " << negFloat.toInt() << " (expected -4)" << std::endl;
	...
	std::cout << "\n=== Anti clockwise cross test ===" << std::endl;
	{
		Point A(0.0f, 0.0f);
		Point B(3.0f, 0.0f);
		Point C(1.5f, 2.0f);
		Point insideCenter(1.5f, 0.666f);
		std::cout << "BSP inside anti clockwise: " << bsp(C, B, A, insideCenter) << " (expected 1)" << std::endl;
		std::cout << cross(C, B, A) << std::endl;
	}
